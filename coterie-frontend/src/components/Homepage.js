    ...
    <div className="homepage w-100">
      ...
      <div className="container homepage-container">
        ...
        <div className="row my-5">
          ...
          <p className="open-sans">We understand that you need help in managing this organization of yours. After all, teaching your flock the ways of righteousness is not an easy task!</p>
        ...
        <div className="row mb-5">
          ...
          <div className="col float-right">
            ...
            <p className="open-sans bold">In order to make this difficult task easier for you, we developed <strong className="open-sans">Coterie</strong>, a unique, online tool to help you manage your organization.</p>
